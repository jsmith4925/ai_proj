...
def new_start():
    edge_rows = [[0,random.randint(0, SECT_Y_COUNT-1)],
                 [SECT_X_COUNT-1, random.randint(0, SECT_Y_COUNT-1)],
                 [random.randint(0, SECT_X_COUNT-1), 0],
                 [random.randint(0, SECT_X_COUNT-1), SECT_Y_COUNT-1]
                 ]
...
def new_maze():
    ...
    for row in range(SECT_X_COUNT-1):
        grid[row][0] = WALL
