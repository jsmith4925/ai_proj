...
def drawPaddle2(paddle2YPos):
    paddle2 = pygame.Rect(WINDOW_WIDTH - PADDLE_BUFFER -
                          PADDLE_WIDTH, paddle2YPos,
                          PADDLE_WIDTH, PADDLE_HEIGHT)
    pygame.draw.rect(screen, WHITE, paddle2)


def updateBall(paddle1YPos, paddle2YPos, ballXPos,
    ...
    if(ballXPos <= PADDLE_BUFFER + PADDLE_WIDTH and
       ...
       ballYPos - BALL_WIDTH <= paddle1YPos + PADDLE_HEIGHT):
        ballXDirection = 1
    elif (ballXPos <= 0):
        ballXDirection = 1
        score = -1
...
class PongGame:
    ...
    def getPresentFrame(self):
        ...
        # copies the pixels from our surface to a 3D array.
        #  we'll use this for RL
    ...
    def getNextFrame(self, action):
        ...
        [score, self.paddle1YPos, self.paddle2YPos, self.ballXPos, self.ballYPos,
            self.ballXDirection, self.ballYDirection] = updateBall(
            self.paddle1YPos, self.paddle2YPos, self.ballXPos,
